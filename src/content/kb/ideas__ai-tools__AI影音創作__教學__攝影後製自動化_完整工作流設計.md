...
<div class="not-prose my-6 bg-red-500/10 border-l-4 border-red-500 rounded-r-lg p-4">
<p class="font-bold text-red-400 mb-2">🔴 標記定義</p>
<div class="text-sm text-gray-300">

所有 AI 處理結果寫回 LR Classic 的 metadata，在 LR 用 Attribute 篩選即可。

</div>
</div>


**第一層：顏色標籤（Color Label）→ 主題分類**
...
| 🟢 綠色 | 食物 | 餐點/飲料 |
| 🔵 藍色 | 建築物 | 建築/室內空間 |
| 🟣 紫色 | 藝術品/其他 | 雕塑/畫作/裝置/其他 |

**第二層：星等（Star Rating）→ 品質等級**
...
**第三層：旗標（Pick Flag）→ 最終保留**

| 旗標 | 意義 |
|------|------|
| 🚩 P（Pick） | 確定保留（4-5 星自動 + 場景保底） |
| ❌ X（Reject） | 刪除候選 |
...
**關鍵字（Keyword）→ 細分標記：**
- 人像子分類：人像-帶景 / 人像-特寫 / 人像-團體
- 場景細節：室內 / 戶外 / 夜景 / 黃昏
- 特殊標記：可發布 / 需精修 / 影片截圖

**管理原則：資料夾為主，集合為輔**
- 場景管理 → 資料夾（一個場景一個資料夾，Finder 也能看）
- 分類篩選 → 顏色標籤 + 星等（LR Attribute 一點就出）
- 跨場景精選 → 智慧集合（自動收集所有 P 旗）
- 50,000 張以上也不混亂
