...
<div class="not-prose my-6 bg-red-500/10 border-l-4 border-red-500 rounded-r-lg p-4">
<p class="font-bold text-red-400 mb-2">🔴 核心原則</p>
<div class="text-sm text-gray-300">

旅遊攝影不是棚拍。有氛圍 = 加分，後製可救 = 不扣分，主體明確 = 核心判斷。
...
**🔴 人像-帶景**
- 加分：人物表情自然有情緒（笑/沈思/凝望）、人與景比例協調、有景深分離感、姿態放鬆不僵硬
- 不扣分：路人入鏡（可後製消除）、手機/雜物入鏡（可裁切）
- 扣分：眼睛沒對焦（降到 2 星）、角度導致臉型不好看（-1 星）

**🔴 人像-特寫**
- 加分：眼睛銳利、表情有情緒、光線有方向感、散景柔順、膚色自然
- 不扣分：現場光線不完美（後製可調）
- 扣分：鼻子或耳朵對焦而非眼睛（降到 2 星）

**🟡 風景**
- 加分：有前中遠景層次、有引導線、光線有戲劇感、色彩豐富
- 不扣分：天空灰白（後製可拉層次）、電線入鏡（可消除）
- 扣分：地平線嚴重歪斜（-1 星）、完全沒有視覺焦點（-1 星）、手震模糊（降到 1 星）

**🔵 建築物**
- 加分：垂直線條正直、對稱或有張力的透視、光影突出質感
- 不扣分：施工/路人（可後製）、電線（可消除）
- 扣分：建築嚴重傾斜未校正（-1 星）

**🟢 食物**
- 加分：色彩鮮豔食慾感強、拍攝角度正確（平拍/俯拍依食物類型）、有光澤質感
- 不扣分：碗盤邊緣不完美（可裁）
- 扣分：食物模糊（降到 2 星）、白光閃光燈直打（-1 星）

**🟣 藝術品/飾品**
- 加分：色彩忠實、主體完整、細節清晰
- 不扣分：展場燈光偏色（後製可校正）
- 扣分：玻璃反光擋住作品（-1 星）、作品被切一半（-1 星）

**P 旗規則（已校準）**
- ⭐⭐⭐⭐ 以上 → 全部 P
- 場景保底 → 若整個場景沒有 4 星以上，挑最佳一張 P
